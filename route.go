...
var route = []webapi.Route{
    ...
    {"GET", "/basicapi/task/list", basicapi.TaskList, "", []context.IFilter{}, []string{"taskGroupId", "taskStatus", "pageSize", "pageIndex", ""}},
    ...
    {"POST", "/basicapi/taskGroup/setEnable", basicapi.SetEnable, "", []context.IFilter{}, []string{"taskGroupId", "enable", ""}},
}

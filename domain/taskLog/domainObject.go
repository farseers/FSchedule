...
func NewDO(mame, caption string, ver int, taskId int64, data collections.Dictionary[string, string], logLevel eumLogLevel.Enum, content string, createAt int64) DomainObject {
	do := DomainObject{
		Name:     mame,
		Caption:  caption,
		Ver:      ver,
